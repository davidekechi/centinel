...
<body class="left-side-menu-dark topbar-light" style="height:106vh;">
    <!-- Begin page -->
    <div id="wrapper">
        ...
        <div class="navbar-custom" style="background-color: #f8fafc;">
            ...
            <div class="carder">
                <ul class="list-unstyled">
                    <li class="text-right"><br/><a style="padding-right:20px;" href="/attendant/plateinserter" target="_blank">Enter Manual Data</a></li>
                </ul>
            </div>
        </div>
        <!-- end Topbar -->
        ...
        <div class="left-side-menu" style="background-color: #373a3c;">
            ...
            <div class="slimscroll-menu">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu" style="margin-bottom: 70px;">
                        ...
                        <li class="menu-title" style="color:white;">
                            ...
                            <div class="mt-3">
                                ...
                                <span style="text-transform: initial;"><span id="mtdAudit">{{round($mtd_audit)}}</span>%</span>
                            </div>
                        </li>
                        <li class="menu-title mt-3 font-weight-bold text-center" style="color:white; font-size:15px;">Camera Selected:</li>
                        <li class="text-center camera 
                            @if ($camera_name == 'All')
                                left-active
                            @endif
                        ">
                        ...
                        @foreach ($cameras as $camera)
                            <li class="text-center camera 
                                @if ($camera_name == $camera->camera)
                                    left-active
                                @endif
                            ">
                                <span class="font-weight-semibold"> 
                                    <a href="?camera={{$camera->camera}}">{{strtoupper($camera->camera)}}</a>
                                </span>
                            </li>
                        @endforeach
                    </ul>
